...
export default function Home() {
  ...
  const sendMessage = async () => {
    setMessages((prevState) =>
        [...prevState, {role: "user", content: userMessage}, {role: "assistant", content: ""}]
    )
        ...
        <Box width = "100vw" height = "100vh" display = "flex" flexDirection = "column" justifyContent = "center" alignItems = "center">
          <Stack direction = "column" width = "500px" height = "700px" border = "1px solid black" p = {2} spacing = {3}>
            ...
            <Stack direction = "row" spacing = {1} sx = {{minWidth : "100%"}}>
              <TextField label = "message" fullWidth value = {userMessage} onChange = {(e) => setUserMessage(e.target.value)}> </TextField>
